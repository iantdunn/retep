...
/**
 * Utility class for creating various embeds used by reaction systems
 */
class EmbedUtils {
    /**
     * Create a reaction roles embed
     * @param {Object} roleEmojis - Mapping of emojis to role IDs
     * @param {Object} options - Optional customization
     * @returns {EmbedBuilder} - Discord embed
     */
    static createReactionRolesEmbed(roleEmojis, options = {}) {
        const embed = new EmbedBuilder()
            .setTitle(options.title || 'Reaction Roles')
            .setDescription(options.description || 'React to this message to give yourself a role. In addition to being pingable, roles will unlock game-specific text channels.')
            .setColor(options.color || '#42f5f5');
    ...
    /**
     * Create a fireboard embed for a message
     * @param {Message} message - Discord message object
     * @param {Array} validReactions - Array of valid reaction objects
     * @param {Object} options - Optional customization
     * @returns {Object} - Discord embed object
     */
    static createFireboardEmbed(message, validReactions, options = {}) {
        ...
        const embed = {
            color: options.color || 0xFF4500, // Orange-red color for fire theme
            author: {
        ...
        if (message.attachments.size > 0) {
            this._addAttachmentFields(embed, message.attachments);
        }
     ...
     * @private
     */
    static _addAttachmentFields(embed, attachments) {
